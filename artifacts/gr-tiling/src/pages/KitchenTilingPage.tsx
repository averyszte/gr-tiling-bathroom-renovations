...
const areas = [
  { ...gridImages.kitchenSplashbacks, label: "Splashbacks",         href: null },
  { ...gridImages.kitchenWalls,       label: "Kitchen Walls",       href: null },
  { ...gridImages.utilityRooms,       label: "Utility Rooms",       href: null },
  { ...gridImages.hallwaysFloors,     label: "Floor & Wall Tiling", href: "/services/floor-wall-tiling-dublin" },
];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative max-w-6xl mx-auto">
            <div className="aspect-[16/10] sm:aspect-[16/9] lg:aspect-[21/9] rounded-2xl overflow-hidden shadow-2xl relative z-10">
              <img src={images.kitchenTilingPage.hero.src} alt={images.kitchenTilingPage.hero.alt} fetchPriority="high" className="w-full h-full object-cover object-center" />
            </div>
