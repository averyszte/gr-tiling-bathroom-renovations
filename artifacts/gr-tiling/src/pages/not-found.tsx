  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center py-32 text-center px-4 bg-background">
      <div className="max-w-md w-full p-8 rounded-2xl bg-card border shadow-lg">
        <h1 className="text-primary font-semibold tracking-wider uppercase text-sm mb-3 block">Page Not Found</h1>
        <h2 className="font-serif text-3xl sm:text-4xl text-foreground mb-4">We Couldn't Find That Page</h2>
